        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              ...
              >
                <h2 className="text-gray-900 font-black text-3xl mb-8" style={{ fontFamily: "Outfit, sans-serif" }}>Send Us a Message</h2>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="text-gray-700 font-semibold text-sm mb-2 block">Full Name *</label>
                      <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="John Smith" className="input-field bg-gray-50" required />
                    </div>
                    <div>
                      <label className="text-gray-700 font-semibold text-sm mb-2 block">Email Address *</label>
                      <input type="email" name="email" value={form.email} onChange={handleChange} placeholder="john@example.com" className="input-field bg-gray-50" required />
                    </div>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="text-gray-700 font-semibold text-sm mb-2 block">Phone Number</label>
                      <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="+1 407 793 8143" className="input-field bg-gray-50" />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea name="message" value={form.message} onChange={handleChange} rows={5} placeholder="Tell us how we can help..." className="input-field bg-gray-50 resize-none" required />
                  </div>
                  <button type="submit" disabled={loading} className="btn-primary bg-blue-600 w-full justify-center text-lg py-4 disabled:opacity-60 disabled:cursor-not-allowed">
