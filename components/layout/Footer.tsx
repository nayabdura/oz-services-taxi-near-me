          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-5">
                ...
                <li>
                  <a href="mailto:oztaxinearme@gmail.com" className="flex items-start gap-4 text-slate-600 hover:text-blue-600 transition-colors group">
                    <div className="mt-1 shrink-0">
                      <FiMail className="w-5 h-5 text-blue-600" />
                    </div>
                    <div className="flex flex-col">
                      <span className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Email Support</span>
                      <span className="text-sm font-bold text-slate-900">oztaxinearme@gmail.com</span>
                    </div>
                  </a>
                </li>
                <li>
